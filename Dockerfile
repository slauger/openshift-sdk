FROM registry.access.redhat.com/ubi9/ubi:9.8-1789348643 AS unarchive
...
FROM quay.io/hypershift/hypershift-operator@sha256:d948df69e6bd8aacb514b452721d8fceac3921beeae25bd38ff49492396bfc77 AS hypershift
